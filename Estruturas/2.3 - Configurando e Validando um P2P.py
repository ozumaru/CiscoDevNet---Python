...
'''
O Intuito do programa é Configurar um Ponto-a-Ponto em duas Caixas com Gerencias já existentes.

E Realizar Ping do Segundo para o Primeiro Device, pois ao entrar no Loop For.
    - Ira acessar o Primeiro Device, Acessar a Interface (Já tento as devidas informações previamente fornecidas)
...
#Lista 'p2p' ira solicitar um IP de REDE para ser configurado, tendo em vista que a mesma já tem a Mascara /30 no indice 1, então será um Ponto a Ponto /30 de qualquer forma
...
for x in range(len(ip)):
    ...
    #Ação ira Quebrar o IP com base nos Pontos, criando uma Lista com 4 Indices, iniciando no 0 e terminando no 3,
    ...
    #Variavel 'p2p' ira receber a lista 'ipp2psplit' contatenando por Ponto, formando novamente o IP e uma Unica String
    ...
    #Variavel 'interface' ira enviar para ambos os Devices o comando da variavel 'confP2P', o que ira diferenciar uma da outra é o em que momendo o Loop estará acontecendo
    ...
    #Condicional IF validando que o Loop está na ultima volta, ira fazer o processo inverso ao de adicionar +1 ao Quarto Octeto, para assim que o segundo Device realize um Ping para o Decice Anterior para Validade Config de ponto a ponto.
    if x == 1:
